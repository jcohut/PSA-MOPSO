# Original algorithm from mopsocd package: https://cran.r-project.org/web/packages/mopsocd/index.html
# with added return values:
...
mopsocds <- function(fn,gn,varcnt,fncnt,lowerbound,upperbound,opt,popsize,maxgen,archivesize,verbosity,pMut,w,c1,c2) UseMethod("mopsocds")
mopsocds <- function(fn,gn=NULL,varcnt,fncnt,lowerbound,upperbound,opt,popsize=100,maxgen=300,archivesize=250,verbosity=0,pMut=0.5,w=0.4,c1=1,c2=1)
{
...
crowding <- function() {
  ...
  # print(sorted_cd$x)
  # print(paste(ndomCtr, length(sorted_cd$x), length(sorted_cd$ix)))
...
maintain_particles <- function(){
    ...
    velocity[wich12,j] <<- -1.0*velocity[wich12,j] ## this part is the boundary strategy, and the direction of particle is reversed.
                                                   ## -1: reflecting, 0: absorbing, (0,-1): damping, -runif(1): bouncing (JH)
  }
