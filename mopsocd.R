...
# with changed and added parameters:
# w1 - initial weight
# w2 - final weight
...
mopsocd <- function(fn,gn,varcnt,fncnt,lowerbound,upperbound,opt,popsize,maxgen,archivesize,verbosity,pMut,w1,w2,c1,c2,vclamp) UseMethod("mopsocd")
mopsocd <- function(fn,gn=NULL,varcnt,fncnt,lowerbound,upperbound,opt,popsize=100,maxgen=300,archivesize=250,verbosity=0,pMut=0.5,w1=0.9,w2=0.4,c1=1.494,c2=1.494,vclamp=0.5)
{
